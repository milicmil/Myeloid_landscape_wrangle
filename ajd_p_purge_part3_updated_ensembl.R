...
######################2020_2 more than 1 adj_p
setwd(human_2020b[[1]])
#adjp_mul_2020b$File[[4]] and adjp_mul_2020b$File[[5]]

container_csv <- read.csv(adjp_mul_2020b$File[[5]], na.strings = c("", "NA"),header =FALSE)

file_name <- adjp_mul_2020b$File_1_adjp[[5]]
file_name
#what col is comp_id
comp_index<- 5
